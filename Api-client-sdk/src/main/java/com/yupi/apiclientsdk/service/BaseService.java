...
import com.yupi.apiclientsdk.exception.ErrorCode;
import com.yupi.apiclientsdk.exception.ErrorResponse;
...
public class BaseService implements ApiService{
    ...
    private Map<String, String> getHeaders(String body, ApiClient apiClient) {
        ...
        hashMap.put("sign", SignUtils.genSign(body, apiClient.getSecretKey()));
        return hashMap;
    }
